        ...
        <div className="bg-white dark:bg-purple-50 rounded-lg shadow-xl p-6 border-2 border-purple-300 dark:border-purple-400">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <label htmlFor="email" className="text-sm font-bold text-purple-900 dark:text-purple-900">
                Email Address
              </label>
              <Input
                id="email"
            ...
            <div className="space-y-2">
              <label htmlFor="password" className="text-sm font-bold text-purple-900 dark:text-purple-900">
                Password
              </label>
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-purple-600 dark:text-purple-600 hover:text-purple-800 dark:hover:text-purple-800"
                  disabled={isLoading}
                >
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center space-x-2 text-sm">
                ...
                />
                <span className="text-purple-700 dark:text-purple-700 font-semibold">Remember me</span>
              </label>
              <Link
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white border-0 font-bold shadow-xl hover:shadow-2xl transition-all duration-300"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
